...
namespace GameStateManagement
{
    ...
    {
        /// <summary>
        /// The base screen size that determines how the graphics device scales
        /// the textures when drawing resolutions different to the base one.
        /// </summary>
        public Vector2 BaseScreenSize
        {
            get { return baseScreenSize; }
            protected set { baseScreenSize = value; }
        }
        
        Vector2 baseScreenSize = new Vector2(1920, 1080);

        /// <summary>
        /// Returns the matrix required to scale any draw calls to desired 
        ...
        public Matrix ResolutionScaleMatrix
        {
            get
            {
                ...
                float horScaling = ScreenManager.GraphicsDevice.PresentationParameters.BackBufferWidth / BaseScreenSize.X;
                float verScaling = ScreenManager.GraphicsDevice.PresentationParameters.BackBufferHeight / BaseScreenSize.Y;
